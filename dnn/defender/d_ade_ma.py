...
from attacker.feature_reverser import obfFeatureReverse
...
ADV_ENS_INFO = {
    ...
    'feature_tp': list(feature_type_scope_dict.keys())[0], #'obf',
    'feature_mapping_type': config.get('feature.obf', 'feature_mp'),
...
class DAdversarialDeepEnsembleMax(BasicDNNModel):
    def __init__(self,
        ...
        feature_reverser = obfFeatureReverse()
