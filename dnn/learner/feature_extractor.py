...
from learner import obf

logger = logging.getLogger('learner.feature')

def normalize_data(X, is_fitting = False, feature_type = 'obf'):
    if is_fitting:
...
def get_droid_feature(data_container, save_dir, feature_type = 'obf'):
    """
